...
var style_EvolucionIndicedeVegetacion_3 = function(feature, resolution){
    ...
    if (value >= -0.072375 && value <= 0.003648) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.003648 && value <= 0.079671) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.079671 && value <= 0.155695) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.155695 && value <= 0.231718) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.231718 && value <= 0.307741) {
            style = [ new ol.style.Style({
