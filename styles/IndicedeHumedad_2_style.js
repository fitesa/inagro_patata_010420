...
var style_IndicedeHumedad_2 = function(feature, resolution){
    ...
    if (value >= -0.011544 && value <= 0.101124) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.101124 && value <= 0.213793) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.213793 && value <= 0.326461) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.326461 && value <= 0.439130) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.439130 && value <= 0.551798) {
            style = [ new ol.style.Style({
