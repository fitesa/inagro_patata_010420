...
var style_IndicedeVegetacion_4 = function(feature, resolution){
    ...
    if (value >= 0.237731 && value <= 0.369253) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.369253 && value <= 0.500776) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.500776 && value <= 0.632298) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.632298 && value <= 0.763820) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.763820 && value <= 0.895343) {
            style = [ new ol.style.Style({
